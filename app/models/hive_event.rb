class HiveEvent < AWS::Record::HashModel
  string_attr :hiveid #HashKey, this will be the hiveid
...
#  def self.new_event(hive_id, data_snapshot, type, details)
  def self.new_event(data)
    ...
    HiveEvent.create(:hiveid => data["value"]["id"], :date_time => data["value"]["date_time"], :data_snapshot => data["value"]["weight"], 
